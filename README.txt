...
type: GET
example curl: curl localhost:5000/<reponame>/<event_type>
...
type: GET
example curl: curl localhost:5000/<reponame>/get_event_types
...
type: POST
example curl: curl -X POST localhost:5000/admin/add_repo/<reponame>

2 Remove tracked repo
endpoint: admin/remove_repo/<owner>/<reponame>
type: POST
example curl: curl -X POST localhost:5000/admin/remove_repo/<reponame>
